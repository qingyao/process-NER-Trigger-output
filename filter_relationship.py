                            ...
                            if (pmid_doc_dict[document_id][e1_id]['par_num'] == pmid_doc_dict[document_id][e2_id]['par_num']):
                                ...
                                for (rel_id, rel_type) in pmid_rel_dict[document_id]: 
                                    ...
                                    with open(args.filtered_relation_with_eid_filepath, 'a') as wf:
                                        ...
                                        print(document_id, e1_id, e2_p, 
                                            tax1_p, str1_p, doc_dict[e1_id]['par_num'], doc_dict[e1_id]['sent_num'], doc_dict[e1_id]['start'], doc_dict[e1_id]['end'],
                                            tax2_p, str2_p, doc_dict[e2_id]['par_num'], doc_dict[e2_id]['sent_num'], doc_dict[e2_id]['start'], doc_dict[e2_id]['end'],
